...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'uuid-of-supplier-tenant' }),
    (0, class_validator_1.IsUUID)(),
    __metadata("design:type", String)
], CreateOrderDto.prototype, "supplierTenantId", void 0);
__decorate([
    (0, swagger_1.ApiPropertyOptional)({ example: 'Urgent order - please expedite' }),
