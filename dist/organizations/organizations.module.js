...
exports.OrganizationsModule = OrganizationsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([organization_entity_1.Organization, tenant_entity_1.Tenant, inventory_item_entity_1.InventoryItem, order_entity_1.Order, order_item_entity_1.OrderItem]),
        ],
        controllers: [organizations_controller_1.OrganizationsController, organizations_controller_1.ChainAdminController],
